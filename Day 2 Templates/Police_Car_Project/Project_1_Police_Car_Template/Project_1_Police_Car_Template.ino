...
//        - This should happen every 0.2 seconds (200 milliseconds)
...
// delay(milliseconds): Countinues the current action for a certain amount of miliseconds      ||     1000 milliseconds = 1 second
...
void loop() 
{ 
  //  First make the buzzer buzz at a high frequency
  ...
  //  First make the buzzer buzz at a lower frequency
